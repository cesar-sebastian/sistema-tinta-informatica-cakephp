<h2 class="sub-header"><small>Cambio contraseña | <?php echo $user['RbacUsuario']['apellido'].', '.$user['RbacUsuario']['nombre'] .' ('.$user['RbacUsuario']['usuario'].')';?></small>  <a class="btn btn-default navbar-right" href="/rbac/rbac_usuarios/">Volver</a></h2>
