<?php if(isset($user['RbacUsuario'])){?>
<h2 class="sub-header"><small>
    <?php if($user['RbacUsuario']['seed'] == NULL)
    	    echo "Nuevo Usuario |";
          else 
          	echo "Recuperar contraseña |";
    ?>
<?php echo $user['RbacUsuario']['nombre'].' '.$user['RbacUsuario']['apellido'].' ('.$user['RbacUsuario']['usuario'].')';?></small></h2>
