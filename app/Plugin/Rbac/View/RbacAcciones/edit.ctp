<div class='container well'>
    ...
    <div class="col-md-10">
        <fieldset>
            <form accept-charset="utf-8" class="form-horizontal" id="RbacAccionEditForm" name="RbacAccionEditForm" role="form" action="/rbac/RbacAcciones/edit/<?php echo $this->data['RbacAccion']['id']; ?>" method="POST">
