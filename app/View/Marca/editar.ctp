...
<div class="row-fluid" style="margin-top: 30px;">
    <div class="col-md-12">
        <fieldset>
            <form class="form-horizontal" id="EditForm" role="form" action="/marca/editar/<?php echo $this->data['Marca']['id']; ?>" method="POST" enctype="multipart/form-data">
                <div class="col-sm-12 well">
                    <div class="control-group form-group">
                        <label for="nombre" class="col-sm-2 control-label">Nombre</label>
                        <div class="col-sm-10">                        
                            <input type="text" class="form-control" id="nombre" name="data[Marca][nombre]" placeholder="Marca" value="<?php echo $this->data['Marca']['nombre']; ?>">
                        </div>
                    </div>
                </div>
