<h2 class="sub-header"><small>Editar producto</small>
...
<div class="row-fluid" style="margin-top: 30px;">
    <div class="col-md-12">
        <fieldset>
            <form class="form-horizontal" id="EditForm" role="form" action="/producto/editar/<?php echo $this->data['Producto']['id']; ?>" method="POST" enctype="multipart/form-data">
                <div class="col-sm-12 well">
                    <div class="control-group form-group">
                        <label for="descripcion" class="col-sm-2 control-label">Descripcion</label>
                        <div class="col-sm-10">                        
                            <input type="text" class="form-control" id="descripcion" name="data[Producto][descripcion]" placeholder="Descripcion" value="<?php echo $this->data['Producto']['descripcion']; ?>">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <label for="costo" class="col-sm-2 control-label">Costo</label>
                        <div class="col-sm-10">                        
                            <input type="text" class="form-control" id="costo" name="data[Producto][costo]" placeholder="Costo" value="<?php echo $this->data['Producto']['costo']; ?>">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <label for="codigo" class="col-sm-2 control-label">Código</label>
                        <div class="col-sm-10">                        
                            <input type="text" class="form-control" id="codigo" name="data[Producto][codigo]" placeholder="Código" value="<?php echo $this->data['Producto']['codigo']; ?>">
                        </div>
                    </div>
                            ...
                            <select id="marca_id" name="data[Producto][marca_id]" class="form-control">
                                ...
                                <?php if ($marcas) { ?>
                                    <?php foreach ($marcas as $data) { ?>                                    
                                        <option value="<?php echo $data['Marca']['id']; ?>" <?php if ($data['Marca']['id'] == $this->data['Producto']['marca_id']) echo "selected"; ?>>
                            ...
                            <select id="marca_id" name="data[Producto][productotipo_id]" class="form-control">
                                ...
                                <?php if ($productoTipos) { ?>
                                    <?php foreach ($productoTipos as $data) { ?>                                    
                                        <option value="<?php echo $data['ProductoTipo']['id']; ?>" <?php if ($data['ProductoTipo']['id'] == $this->data['Producto']['productotipo_id']) echo "selected"; ?>>
