;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoTextFiltered: '<span class="label label-warning">Filtrado</span> {0} / {1}', // when not all of the options are visible due to the filter
